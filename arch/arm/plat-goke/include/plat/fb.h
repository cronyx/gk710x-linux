...
enum gk_osd_color_format {
    GK_OSD_COLOR_AYUV4444 = 0,
    GK_OSD_COLOR_AYUV1555 = 1,        
    GK_OSD_COLOR_YUV555   = 2,
    GK_OSD_COLOR_YUV565   = 3,
    GK_OSD_COLOR_UNSUPPORTED
};
...
struct gk_platform_fb {
    ...
    u32                         proc_wait_flag;
    enum gk_osd_color_format    convert_format;//valid only when ABGR8888/RGBA8888->AYUV4444/AYUV1555/YUV555
};
