...
**
** \version     $Id: gk_gpio_v1_10.h 12845 2017-10-14 03:43:27Z weiqiang $
**
** \brief
**
...
typedef enum
{
    ...
    //GPIO_TYPE_INOUT_SD1_DATA_0                                                                                                                                         GPIO_SET_OEN_SEL(20)                           GPIO_SET_OUT_SEL(51)    //!< Input/Output type: sd1_data_out[0]
    //GPIO_TYPE_INOUT_SD1_DATA_1                                                                                                                                         GPIO_SET_OEN_SEL(21)                           GPIO_SET_OUT_SEL(52)    //!< Input/Output type: sd1_data_out[1]
    //GPIO_TYPE_INOUT_SD1_DATA_2                                                                                                                                         GPIO_SET_OEN_SEL(22)                           GPIO_SET_OUT_SEL(53)    //!< Input/Output type: sd1_data_out[2]
    //GPIO_TYPE_INOUT_SD1_DATA_3                                                                                                                                         GPIO_SET_OEN_SEL(23)                           GPIO_SET_OUT_SEL(54)    //!< Input/Output type: sd1_data_out[3]
    //GPIO_TYPE_INOUT_SD1_CMD                                                                                                                                            GPIO_SET_OEN_SEL(24)                           GPIO_SET_OUT_SEL(55)    //!< Input/Output type: sd1_cmd
    GPIO_TYPE_OUTPUT_SD1_CLK         = GPIO_SET_FUNC(GPIO_FUNC_OUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)     | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 0) | GPIO_SET_IN_SEL( 0)   | GPIO_SET_OUT_SEL(56),   //!< Output type: sd1_clk_sdcard
    GPIO_TYPE_OUTPUT_JTAG_TDO        = GPIO_SET_FUNC(GPIO_FUNC_OUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 0) | GPIO_SET_IN_SEL( 0)   | GPIO_SET_OUT_SEL(57),   //!< Output type: jtag_tdout
    ...
    //GPIO_TYPE_INOUT_ICC_DATA                                                                                                                                                                                          GPIO_SET_OUT_SEL(106)   //!< Input/Output type: icc_1_data
    //GPIO_TYPE_INOUT_ICC_CLK                                                                                                                                                                                           GPIO_SET_OUT_SEL(107)   //!< Input/Output type: icc_1_clk
    GPIO_TYPE_OUTPUT_ICC_RST         = GPIO_SET_FUNC(GPIO_FUNC_OUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(28) | GPIO_SET_IN_SEL( 0)   | GPIO_SET_OUT_SEL(108),  //!< Output type: icc_rst
    GPIO_TYPE_OUTPUT_ICC_VCC         = GPIO_SET_FUNC(GPIO_FUNC_OUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(29) | GPIO_SET_IN_SEL( 0)   | GPIO_SET_OUT_SEL(109),  //!< Output type: icc_vcc
    GPIO_TYPE_OUTPUT_ICC_VPP         = GPIO_SET_FUNC(GPIO_FUNC_OUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(30) | GPIO_SET_IN_SEL( 0)   | GPIO_SET_OUT_SEL(110),  //!< Output type: icc_vpp
    //GPIO_TYPE_INOUT_I2S_DATA2                                                                                                                                                                                         GPIO_SET_OUT_SEL(111)   //!< Input/Output type: i2s_data2
    //GPIO_TYPE_INOUT_I2S_DATA1                                                                                                                                                                                         GPIO_SET_OUT_SEL(112)   //!< Input/Output type: i2s_data1
    //GPIO_TYPE_INOUT_SF_HOLD                                                                                                                                                                                           GPIO_SET_OUT_SEL(113)   //!< Input/Output type: sf_hold
    //GPIO_TYPE_INOUT_SF_WP                                                                                                                                                                                             GPIO_SET_OUT_SEL(114)   //!< Input/Output type: sf_wp
    GPIO_TYPE_OUTPUT_DSP_UART0_TX    = GPIO_SET_FUNC(GPIO_FUNC_OUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)     | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 0) | GPIO_SET_IN_SEL( 0)   | GPIO_SET_OUT_SEL(115),  //!< Input type: dsp_uart_tx
    ...
    //GPIO_TYPE_INOUT_SD1_DATA_0                                                                                                                                                                GPIO_SET_IN_SEL(2+40)                           //!< Input/Output type: sd1_data_out[0]
    //GPIO_TYPE_INOUT_SD1_DATA_1                                                                                                                                                                GPIO_SET_IN_SEL(2+41)                           //!< Input/Output type: sd1_data_out[1]
    //GPIO_TYPE_INOUT_SD1_DATA_2                                                                                                                                                                GPIO_SET_IN_SEL(2+42)                           //!< Input/Output type: sd1_data_out[2]
    //GPIO_TYPE_INOUT_SD1_DATA_3                                                                                                                                                                GPIO_SET_IN_SEL(2+43)                           //!< Input/Output type: sd1_data_out[3]
    //GPIO_TYPE_INOUT_SD1_CMD                                                                                                                                                                   GPIO_SET_IN_SEL(2+44)                           //!< Input/Output type: sd1_cmd
    ...
    GPIO_TYPE_INPUT_SENSOR_IDSP      = GPIO_SET_FUNC(GPIO_FUNC_IN)  | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 1) | GPIO_SET_IN_SEL(2+60) | GPIO_SET_OUT_SEL( 0),   //!< Input type: sensor_idsp_field
    //GPIO_TYPE_INOUT_ICC_DATA                                                                                                                                                                  GPIO_SET_IN_SEL(2+61)                           //!< Input/Output type: icc_1_data
    //GPIO_TYPE_INOUT_ICC_CLK                                                                                                                                                                   GPIO_SET_IN_SEL(2+62)                           //!< Input/Output type: icc_1_clk
    //GPIO_TYPE_INOUT_I2S_DATA1                                                                                                                                                                 GPIO_SET_IN_SEL(2+63)                           //!< Input/Output type: i2s_data1
    //GPIO_TYPE_INOUT_I2S_DATA2                                                                                                                                                                 GPIO_SET_IN_SEL(2+64)                           //!< Input/Output type: i2s_data2
    //GPIO_TYPE_INOUT_SF_HOLD                                                                                                                                                                   GPIO_SET_IN_SEL(2+65)                           //!< Input/Output type: sf_hold
    //GPIO_TYPE_INOUT_SF_WP                                                                                                                                                                     GPIO_SET_IN_SEL(2+66)                           //!< Input/Output type: sf_wp
    GPIO_TYPE_INPUT_DSP_UART0_RX     = GPIO_SET_FUNC(GPIO_FUNC_IN)  | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)     | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 1) | GPIO_SET_IN_SEL(2+67) | GPIO_SET_OUT_SEL( 0),   //!< Input type: dsp_uart_rx
    ...
    GPIO_TYPE_INOUT_SD1_DATA_0       = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(20) | GPIO_SET_IN_SEL(2+40) | GPIO_SET_OUT_SEL(51),   //!< Input/Output type: sd1_data_out[0]
    GPIO_TYPE_INOUT_SD1_DATA_1       = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(21) | GPIO_SET_IN_SEL(2+41) | GPIO_SET_OUT_SEL(52),   //!< Input/Output type: sd1_data_out[1]
    GPIO_TYPE_INOUT_SD1_DATA_2       = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(22) | GPIO_SET_IN_SEL(2+42) | GPIO_SET_OUT_SEL(53),   //!< Input/Output type: sd1_data_out[2]
    GPIO_TYPE_INOUT_SD1_DATA_3       = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(23) | GPIO_SET_IN_SEL(2+43) | GPIO_SET_OUT_SEL(54),   //!< Input/Output type: sd1_data_out[3]
    GPIO_TYPE_INOUT_SD1_CMD          = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_UP|IOCTRL_2MA)   | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(24) | GPIO_SET_IN_SEL(2+44) | GPIO_SET_OUT_SEL(55),   //!< Input/Output type: sd1_cmd
    ...
    GPIO_TYPE_INOUT_ICC_DATA         = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA) | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(26) | GPIO_SET_IN_SEL(2+61) | GPIO_SET_OUT_SEL(106),  //!< Input/Output type: icc_1_data
    GPIO_TYPE_INOUT_ICC_CLK          = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA) | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(27) | GPIO_SET_IN_SEL(2+62) | GPIO_SET_OUT_SEL(107),  //!< Input/Output type: icc_1_clk
    GPIO_TYPE_INOUT_I2S_DATA1        = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA) | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 0) | GPIO_SET_IN_SEL(2+63) | GPIO_SET_OUT_SEL(112),  //!< Input/Output type: i2s_data1
    GPIO_TYPE_INOUT_I2S_DATA2        = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA) | GPIO_SET_OEN_INVERT(1) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL( 0) | GPIO_SET_IN_SEL(2+64) | GPIO_SET_OUT_SEL(111),  //!< Input/Output type: i2s_data2
    GPIO_TYPE_INOUT_SF_HOLD          = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA) | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(32) | GPIO_SET_IN_SEL(2+66) | GPIO_SET_OUT_SEL(113),  //!< Input/Output type: sf_hold
    GPIO_TYPE_INOUT_SF_WP            = GPIO_SET_FUNC(GPIO_FUNC_INOUT) | GPIO_SET_IOCTRL(IOCTRL_PULL_DOWN|IOCTRL_2MA) | GPIO_SET_OEN_INVERT(0) | GPIO_SET_OUT_INVERT(0) | GPIO_SET_OEN_SEL(31) | GPIO_SET_IN_SEL(2+65) | GPIO_SET_OUT_SEL(114),  //!< Input/Output type: sf_wp
