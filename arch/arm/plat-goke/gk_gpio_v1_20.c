/*
 * arch/arm/plat-goke/gk_gpio_v1_20.c
 *
...
GPIO_TYPE_E gk_gpio_table[GK_GPIO_FUN_ALL] =
{
    ...
    [(GK_GPIO_SPI0_CS4)]           = GPIO_TYPE_OUTPUT_SPI0_CS4,
    [(GK_GPIO_SPI0_CS5)]           = GPIO_TYPE_OUTPUT_SPI0_CS5,
    [(GK_GPIO_SPI0_CS6)]           = GPIO_TYPE_OUTPUT_SPI0_CS6,
    [(GK_GPIO_SPI0_CS7)]           = GPIO_TYPE_OUTPUT_SPI0_CS7,
    ...
    [(GK_GPIO_SDIO0_DATA_4)]       = GPIO_TYPE_INOUT_SD0_DATA_4,
    [(GK_GPIO_SDIO0_DATA_5)]       = GPIO_TYPE_INOUT_SD0_DATA_5,
    [(GK_GPIO_SDIO0_DATA_6)]       = GPIO_TYPE_INOUT_SD0_DATA_6,
    [(GK_GPIO_SDIO0_DATA_7)]       = GPIO_TYPE_INOUT_SD0_DATA_7,
    ...
    [(GK_GPIO_VD_DATA16)]          = GPIO_TYPE_OUTPUT_VD_DATA16,
    [(GK_GPIO_VD_DATA17)]          = GPIO_TYPE_OUTPUT_VD_DATA17,
    [(GK_GPIO_VD_DATA18)]          = GPIO_TYPE_OUTPUT_VD_DATA18,
    [(GK_GPIO_VD_DATA19)]          = GPIO_TYPE_OUTPUT_VD_DATA19,
    [(GK_GPIO_VD_DATA20)]          = GPIO_TYPE_OUTPUT_VD_DATA20,
    [(GK_GPIO_VD_DATA21)]          = GPIO_TYPE_OUTPUT_VD_DATA21,
    [(GK_GPIO_VD_DATA22)]          = GPIO_TYPE_OUTPUT_VD_DATA22,
    [(GK_GPIO_VD_DATA23)]          = GPIO_TYPE_OUTPUT_VD_DATA23,
    [(GK_GPIO_I80_LCD_RST)]        = GPIO_TYPE_OUTPUT_I80_LCD_RST,
    [(GK_GPIO_I80_RDN)]            = GPIO_TYPE_OUTPUT_I80_RDN,
    [(GK_GPIO_I80_WRN)]            = GPIO_TYPE_OUTPUT_I80_WRN,
    [(GK_GPIO_I80_DCX)]            = GPIO_TYPE_OUTPUT_I80_DCX,
    [(GK_GPIO_I80_CSN)]            = GPIO_TYPE_OUTPUT_I80_CSN,
    [(GK_GPIO_I80_DATA0)]          = GPIO_TYPE_INOUT_I80_DATA0,
    [(GK_GPIO_I80_DATA1)]          = GPIO_TYPE_INOUT_I80_DATA1,
    [(GK_GPIO_I80_DATA2)]          = GPIO_TYPE_INOUT_I80_DATA2,
    [(GK_GPIO_I80_DATA3)]          = GPIO_TYPE_INOUT_I80_DATA3,
    [(GK_GPIO_I80_DATA4)]          = GPIO_TYPE_INOUT_I80_DATA4,
    [(GK_GPIO_I80_DATA5)]          = GPIO_TYPE_INOUT_I80_DATA5,
    [(GK_GPIO_I80_DATA6)]          = GPIO_TYPE_INOUT_I80_DATA6,
    [(GK_GPIO_I80_DATA7)]          = GPIO_TYPE_INOUT_I80_DATA7,
    [(GK_GPIO_I80_DATA8)]          = GPIO_TYPE_INOUT_I80_DATA8,
    [(GK_GPIO_I80_OUTPUT_DATA0)]   = GPIO_TYPE_OUTPUT_I80_DATA0,
    [(GK_GPIO_I80_OUTPUT_DATA1)]   = GPIO_TYPE_OUTPUT_I80_DATA1,
    [(GK_GPIO_I80_OUTPUT_DATA2)]   = GPIO_TYPE_OUTPUT_I80_DATA2,
    [(GK_GPIO_I80_OUTPUT_DATA3)]   = GPIO_TYPE_OUTPUT_I80_DATA3,
    [(GK_GPIO_I80_OUTPUT_DATA4)]   = GPIO_TYPE_OUTPUT_I80_DATA4,
    [(GK_GPIO_I80_OUTPUT_DATA5)]   = GPIO_TYPE_OUTPUT_I80_DATA5,
    [(GK_GPIO_I80_OUTPUT_DATA6)]   = GPIO_TYPE_OUTPUT_I80_DATA6,
    [(GK_GPIO_I80_OUTPUT_DATA7)]   = GPIO_TYPE_OUTPUT_I80_DATA7,
    [(GK_GPIO_I80_OUTPUT_DATA8)]   = GPIO_TYPE_OUTPUT_I80_DATA8,
    [(GK_GPIO_I80_INPUT_DATA0)]    = GPIO_TYPE_INPUT_I80_DATA0,
    [(GK_GPIO_I80_INPUT_DATA1)]    = GPIO_TYPE_INPUT_I80_DATA1,
    [(GK_GPIO_I80_INPUT_DATA2)]    = GPIO_TYPE_INPUT_I80_DATA2,
    [(GK_GPIO_I80_INPUT_DATA3)]    = GPIO_TYPE_INPUT_I80_DATA3,
    [(GK_GPIO_I80_INPUT_DATA4)]    = GPIO_TYPE_INPUT_I80_DATA4,
    [(GK_GPIO_I80_INPUT_DATA5)]    = GPIO_TYPE_INPUT_I80_DATA5,
    [(GK_GPIO_I80_INPUT_DATA6)]    = GPIO_TYPE_INPUT_I80_DATA6,
    [(GK_GPIO_I80_INPUT_DATA7)]    = GPIO_TYPE_INPUT_I80_DATA7,
    [(GK_GPIO_I80_INPUT_DATA8)]    = GPIO_TYPE_INPUT_I80_DATA8,
    ...
    [(GK_GPIO_AO0_MCLK)]           = GPIO_TYPE_OUTPUT_AOMCLK,
    [(GK_GPIO_AO0_BCLK)]           = GPIO_TYPE_OUTPUT_AOBCLK,
    [(GK_GPIO_AO0_LRCLK)]          = GPIO_TYPE_OUTPUT_AOLRCLK,
    [(GK_GPIO_AO0_DATA)]           = GPIO_TYPE_OUTPUT_AO_DATA0,
    ...
    [(GK_GPIO_AI0_MCLK)]           = GPIO_TYPE_INPUT_CLK_AU,//????
    [(GK_GPIO_AI0_BCLK)]           = GPIO_TYPE_INPUT_I2S_CLK,//????
    [(GK_GPIO_AI0_LRCLK)]          = GPIO_TYPE_INPUT_I2S_WS,
    [(GK_GPIO_AI0_DATA)]           = GPIO_TYPE_INPUT_I2S_SI,
    ...
    [(GK_GPIO_TIMER1_CLK)]         = GPIO_TYPE_INPUT_TIMER1_CLK,
    [(GK_GPIO_TIMER2_CLK)]         = GPIO_TYPE_INPUT_TIMER2_CLK,
    [(GK_GPIO_TIMER3_CLK)]         = GPIO_TYPE_INPUT_TIMER3_CLK,
    [(GK_GPIO_RCT_CLK_OUT1)]       = GPIO_TYPE_OUTPUT_RCT_CLK_OUT1,
    [(GK_GPIO_RCT_CLK_OUT2)]       = GPIO_TYPE_OUTPUT_RCT_CLK_OUT2,
};
