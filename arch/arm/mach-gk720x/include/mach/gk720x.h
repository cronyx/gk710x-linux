...
extern u32 get_hevcmem_phys(void);
extern u32 get_hevcmem_virt(void);
extern u32 get_hevcmem_size(void);
...
extern u32 get_logo_virt(void);
extern u32 get_logo_pitch(void);
extern u32 get_logo_size(void);
#endif  /* __MACH_GK_H */
